 ...
 * Product
 *
 * @ORM\Table(name="product", indexes={@ORM\Index(name="comment", columns={"comments"}), @ORM\Index(name="idSection", columns={"idSection"}), @ORM\Index(name="name", columns={"name"})})
 * @ORM\Entity
 */
class Product
{
     ...
     * @var \Doctrine\Common\Collections\Collection
     *
     * @ORM\ManyToMany(targetEntity="Command", mappedBy="idproduct")
     */
    private $idcommand;
    ...
    public function __construct()
    {
        ...
        $this->idcommand = new \Doctrine\Common\Collections\ArrayCollection();
    ...
    {
        if (!$this->idcommand->contains($idcommand)) {
            $this->idcommand[] = $idcommand;
            $idcommand->addIdproduct($this);
        }
    ...
    {
        if ($this->idcommand->removeElement($idcommand)) {
            $idcommand->removeIdproduct($this);
        }
